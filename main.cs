...
class MainClass {
  ...
  {
    Console.WriteLine("\n");
    Console.WriteLine("Digite com a palavra chave da busca");
    string resultadoBusca = Console.ReadLine();
    List<Produto> produtos = Produto.PesquisarEstoque("%"+resultadoBusca+"%");
    foreach(var produto in produtos)
    {
      produto.Imprimir();
    }
